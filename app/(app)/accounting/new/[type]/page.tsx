...
const TYPES = ["Invoice","SalesReceipt","CreditNote","RefundReceipt","Bill","Expense","VendorCredit","Payment","BillPayment","Deposit","Transfer","Estimate","PurchaseOrder"] as const;
