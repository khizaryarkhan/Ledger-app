  ...
  return (
    <div className="p-6 max-w-5xl">
      <div className="flex items-center gap-3 mb-1">
        ...
        <h1 className="text-xl font-semibold text-stone-100">Download</h1>
      </div>
      <p className="text-sm text-stone-400 mb-6 ml-12">Export QuickBooks data to a spreadsheet. Exports include Id and SyncToken columns so you can edit and re-import via Modify.</p>
      ...
      <div className="text-sm font-medium text-stone-300 mb-3">1. Choose what to export</div>
      <EntityPicker capability="download" selected={entityId} onSelect={setEntityId} />
